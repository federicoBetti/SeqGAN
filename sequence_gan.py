...
'''
This is the original project on fake synthetic discrete data, not specifically words!
'''
#########################################################################################
...
def pre_train_epoch(sess, trainable_model, data_loader):
    ...
    # return the mean of the loss on the batches
...
def main():
    ...
    for _ in range(50):
        # i'm doing it for 50 different fake generated samples!
